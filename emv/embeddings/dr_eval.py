...
def random_triplet_accuracy(knn_high_dim, original_d, embeddings_d, sampling, n_triplets = 1000, n_repetitions = 10, size_neighborhood = 10):
    ...
    for _ in range(n_repetitions):
        triplets = get_triplets(knn_high_dim, n_triplets = n_triplets, sampling = sampling, n_neighbors = size_neighborhood)
        relative_d_original, relative_d_embedded = compute_relative_distances(original_d, embeddings_d, triplets)
