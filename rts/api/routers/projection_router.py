...
from rts.db.queries import create_projection, get_projection_by_id, get_all_projections, update_projection, delete_projection, get_projection_coordinates, get_projection_atlases
...
async def read_projection_coordinates(projection_id: int):
    return get_projection_coordinates(projection_id)


@projection_router.get("/projections/{projection_id}/atlases")
async def read_projection_atlases(projection_id: int):
